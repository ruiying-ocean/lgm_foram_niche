...
+ xx_foramecogenie.csv: the model output (the abbreviation is bn: symbiont-barren non-spinose; bs: symbiont-barren spinose; sn: symbiont-facultative non-spinose; ss: symbiont-obligate spinose)
